...
Aplikasi ini memecahkan masalah tersebut dengan pendekatan **PWA (Progressive Web App)**. Tamu hanya perlu memindai *QR Code* di meja mereka, memotret, dan momen tersebut langsung tayang di layar proyektor acara.
...
Tidak perlu khawatir ada foto yang tidak pantas tayang di layar besar. Semua foto masuk ke dasbor moderator untuk disortir (Setujui/Tolak) oleh panitia atau *Wedding Organizer* sebelum ditampilkan.
...
### 📦 Bride & Groom Hub
Pusat kendali khusus bagi pengantin setelah acara selesai. Cukup dengan satu klik, pengantin dapat mengunduh (*download*) seluruh koleksi kenangan ke dalam satu file `.ZIP` utuh.

---

## 🚀 Pengembangan Fitur Selanjutnya (Roadmap)
Aplikasi ini dirancang fleksibel untuk pengembangan lebih lanjut, di antaranya:
- [ ] Autentikasi Pengguna & Integrasi Sosial Media
- [ ] Fitur Buku Tamu Digital (Pesan & Doa berbasis teks/video)
- [ ] Kustomisasi Tema Acara secara dinamis (Editor Tema UI)
